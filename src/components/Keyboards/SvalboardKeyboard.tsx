    ...
    const customKeyboardOptions = {
        ...
        layout: {
            default: [
                ...
                "SV_SNIPER_2_TG SV_SNIPER_3_TG SV_SNIPER_5_TG",
        ...
        display: {
            ...
            SV_SNIPER_3: "Sniper\n3x",
            SV_SNIPER_5: "Sniper\n5x",
            SV_SNIPER_2_TG: "Sniper\n2xTG",
            SV_SNIPER_3_TG: "Sniper\n3xTG",
            SV_SNIPER_5_TG: "Sniper\n5xTG",
        ...
        buttonTheme: [
            {
                class: "kb-key",
                buttons:
                    "SV_LEFT_DPI_INC SV_LEFT_DPI_DEC SV_RIGHT_DPI_INC SV_RIGHT_DPI_DEC SV_LEFT_SCROLL_TOGGLE SV_RIGHT_SCROLL_TOGGLE SV_RECALIBRATE_POINTER SV_MH_CHANGE_TIMEOUTS SV_CAPS_WORD SV_TOGGLE_ACHORDION SV_TOGGLE_23_67 SV_TOGGLE_45_67 SV_SNIPER_2 SV_SNIPER_3 SV_SNIPER_5 SV_SNIPER_2_TG SV_SNIPER_3_TG SV_SNIPER_5_TG SV_SCROLL_HOLD SV_SCROLL_TOGGLE SV_OUTPUT_STATUS",
            },
            {
                class: "kb-norender",
                buttons:
